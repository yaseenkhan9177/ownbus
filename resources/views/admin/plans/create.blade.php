...
@section('title', 'Create Subscription Plan | SaaS Admin')
        ...
        <div class="bg-[#0f1524] rounded-xl border border-slate-800 p-6 shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Internal Plan Name (e.g. "Enterprise", "Starter")</label>
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg px-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all font-medium">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="price_monthly" value="{{ old('price_monthly', 0) }}" required class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg pl-8 pr-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all font-mono">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="price_yearly" value="{{ old('price_yearly', 0) }}" required class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg pl-8 pr-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all font-mono">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="trial_days" value="{{ old('trial_days', 14) }}" required min="0" class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg px-4 py-3 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all font-mono">
                </div>
                ...
                <div class="flex items-center h-full pt-6">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-bold text-slate-300 uppercase tracking-wider">Plan Active (Available immediately)</span>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#0f1524] rounded-xl border border-slate-800 p-6 shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input type="number" name="max_vehicles" value="{{ old('max_vehicles', 10) }}" required min="-1" class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg px-4 py-3 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-mono">
                </div>

                <!-- User Limit -->
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Max System Users / Drivers</label>
                    <input type="number" name="max_users" value="{{ old('max_users', 5) }}" required min="-1" class="w-full bg-slate-900 border border-slate-700 text-slate-200 rounded-lg px-4 py-3 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-mono">
                </div>
            </div>
            ...
            <div class="pt-6 border-t border-slate-800/80">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label class="flex items-center p-4 bg-slate-800/30 border border-slate-700 rounded-lg cursor-pointer hover:bg-slate-800/50 transition-colors">
                        <input type="checkbox" name="features[api_access]" value="1" class="w-4 h-4 text-purple-600 bg-slate-900 border-slate-700 rounded focus:ring-purple-500 focus:ring-2" {{ old('features.api_access') ? 'checked' : '' }}>
                        <span class="ml-3 text-sm font-medium text-slate-300">API Access</span>
                    </label>

                    <label class="flex items-center p-4 bg-slate-800/30 border border-slate-700 rounded-lg cursor-pointer hover:bg-slate-800/50 transition-colors">
                        <input type="checkbox" name="features[custom_domain]" value="1" class="w-4 h-4 text-purple-600 bg-slate-900 border-slate-700 rounded focus:ring-purple-500 focus:ring-2" {{ old('features.custom_domain') ? 'checked' : '' }}>
                        <span class="ml-3 text-sm font-medium text-slate-300">Custom Domain Mapping</span>
                    </label>

                    <label class="flex items-center p-4 bg-slate-800/30 border border-slate-700 rounded-lg cursor-pointer hover:bg-slate-800/50 transition-colors">
                        <input type="checkbox" name="features[white_label]" value="1" class="w-4 h-4 text-purple-600 bg-slate-900 border-slate-700 rounded focus:ring-purple-500 focus:ring-2" {{ old('features.white_label') ? 'checked' : '' }}>
