...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\xampp\htdocs\work shop\bus-rental-app\public\storage' => 'string',
            ...
            'logging.channels.subscriptions.driver' => 'string',
            'logging.channels.subscriptions.path' => 'string',
            'logging.channels.subscriptions.level' => 'string',
            'logging.channels.subscriptions.days' => 'integer',
            'logging.channels.subscriptions.replace_placeholders' => 'boolean',
            'logging.channels.payments.driver' => 'string',
            'logging.channels.payments.path' => 'string',
            'logging.channels.payments.level' => 'string',
            'logging.channels.payments.days' => 'integer',
            'logging.channels.payments.replace_placeholders' => 'boolean',
            'logging.channels.rentals.driver' => 'string',
            'logging.channels.rentals.path' => 'string',
            'logging.channels.rentals.level' => 'string',
            'logging.channels.rentals.days' => 'integer',
            'logging.channels.rentals.replace_placeholders' => 'boolean',
            'logging.channels.pricing.driver' => 'string',
            'logging.channels.pricing.path' => 'string',
            'logging.channels.pricing.level' => 'string',
            'logging.channels.pricing.days' => 'integer',
            'logging.channels.pricing.replace_placeholders' => 'boolean',
            ...
            'logging.channels.webhooks.driver' => 'string',
            'logging.channels.webhooks.path' => 'string',
            'logging.channels.webhooks.level' => 'string',
            'logging.channels.webhooks.days' => 'integer',
            'logging.channels.webhooks.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'access-admin-panel','access-company-panel','viewAny','view','create',
...
'database.connections.tenant.driver','database.connections.tenant.url','database.connections.tenant.host','database.connections.tenant.port','database.connections.tenant.database',
'database.connections.tenant.username','database.connections.tenant.password','database.connections.tenant.unix_socket','database.connections.tenant.charset','database.connections.tenant.collation',
'database.connections.tenant.prefix','database.connections.tenant.prefix_indexes','database.connections.tenant.strict','database.connections.tenant.engine','database.connections.tenant.options',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\xampp\\htdocs\\work shop\\bus-rental-app\\public\\storage','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.subscriptions.driver','logging.channels.subscriptions.path',
'logging.channels.subscriptions.level','logging.channels.subscriptions.days','logging.channels.subscriptions.replace_placeholders','logging.channels.payments.driver','logging.channels.payments.path',
'logging.channels.payments.level','logging.channels.payments.days','logging.channels.payments.replace_placeholders','logging.channels.rentals.driver','logging.channels.rentals.path',
'logging.channels.rentals.level','logging.channels.rentals.days','logging.channels.rentals.replace_placeholders','logging.channels.pricing.driver','logging.channels.pricing.path',
'logging.channels.pricing.level','logging.channels.pricing.days','logging.channels.pricing.replace_placeholders','logging.channels.security.driver','logging.channels.security.path',
'logging.channels.security.level','logging.channels.security.days','logging.channels.security.replace_placeholders','logging.channels.webhooks.driver','logging.channels.webhooks.path',
'logging.channels.webhooks.level','logging.channels.webhooks.days','logging.channels.webhooks.replace_placeholders','mail.default','mail.mailers.smtp.transport',
...
'services.slack.notifications.channel','services.stripe.key','services.stripe.secret','services.stripe.webhook_secret','session.driver',
...
'role_or_permission','isSuperAdmin','customer.auth','abilities','ability',
'subscription.active','plan','driver.pin',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','api.gps.ping','api.gps.vehicle-location','api.gps.fleet-snapshot','welcome',
'demo.login','login','logout','register',
'register.process','agreement.show','super-admin.pin','super-admin.','super-admin.register',
'super-admin.','portal.vehicles.index','portal.vehicles.show','portal.vehicles.check-availability','portal.login',
'portal.register','portal.dashboard','portal.rentals.index','portal.rentals.invoice','portal.bookings.create',
'portal.bookings.calculate-price','portal.bookings.store','portal.bookings.show','portal.bookings.cancel','portal.payments.show',
'portal.payments.success','portal.payments.cancel','portal.notifications.index','portal.notifications.read','portal.notifications.mark-all-read',
'portal.notifications.destroy','portal.settings.notifications','portal.settings.notifications.update','portal.webhook.stripe','quote.check',
'quote.book','dashboard','impersonation.leave','admin.dashboard','admin.exports.store',
'admin.requests.index','admin.requests.approve','admin.requests.reject','admin.companies.impersonate','admin.companies.approve',
'admin.companies.toggle-status','admin.companies.grant-license','admin.companies.index','admin.companies.create','admin.companies.store',
'admin.companies.show','admin.companies.edit','admin.companies.update','admin.companies.destroy','admin.plans.index',
'admin.plans.create','admin.plans.store','admin.plans.show','admin.plans.edit','admin.plans.update',
'admin.plans.destroy','admin.support.index','admin.support.show','admin.support.reply','admin.support.update-status',
'admin.billing.index','admin.analytics.index','admin.system.index','admin.audit-logs.index','admin.trash.index',
'admin.trash.restore','admin.trash.force-delete','admin.settings.index','admin.settings.update','admin.broadcasts.index',
'admin.broadcasts.store','admin.broadcasts.destroy','admin.agreements.index','admin.agreements.create','admin.agreements.store',
'admin.agreements.edit','admin.agreements.update','admin.agreements.activate','admin.agreements.destroy','subscription.show',
'subscription.upgrade','subscription.checkout','subscription.success','subscription.expired','subscription.plans',
'company.dashboard','company.dashboard.utilization-trend','company.intelligence.executive','company.intelligence.calculate-rate','company.pricing.index',
'company.pricing.calculate','company.maintenance.predictions','company.maintenance.predictions.run','company.command-center','company.command-center.api',
'company.kanban.index','company.kanban.update-status','company.kanban.suggest-drivers','company.kanban.assign-driver','company.fleet.analytics',
'company.fleet.calendar','company.fleet.calendar.events','company.telematics.dashboard','company.maintenance.schedule','company.maintenance.complete',
'company.maintenance.cancel','company.maintenance.index','company.maintenance.create','company.maintenance.store','company.maintenance.show',
'company.maintenance.edit','company.maintenance.update','company.maintenance.destroy','company.fleet.index','company.fleet.create',
'company.fleet.store','company.fleet.show','company.fleet.edit','company.fleet.update','company.fleet.destroy',
'company.branches.index','company.branches.create','company.branches.store','company.branches.show','company.branches.edit',
'company.branches.update','company.branches.destroy','company.rentals.contract','company.rentals.contract.store','company.rentals.transition',
'company.api.rental.price','company.rentals.index','company.rentals.create','company.rentals.store','company.rentals.show',
'company.rentals.edit','company.rentals.update','company.rentals.destroy','company.trips.index','company.trips.show',
'company.trips.cancel','company.fuel.index','company.fuel.store','company.fuel.show','company.fuel.destroy',
'company.breakdowns.index','company.breakdowns.show','company.breakdowns.acknowledge','company.breakdowns.resolve','company.drivers.toggle-status',
'company.drivers.index','company.drivers.create','company.drivers.store','company.drivers.show','company.drivers.edit',
'company.drivers.update','company.drivers.destroy','company.customers.index','company.customers.create','company.customers.store',
'company.customers.show','company.customers.edit','company.customers.update','company.customers.destroy','company.finance.dashboard',
'company.finance.transactions','company.finance.invoices','company.finance.payments.store','company.vendors.suspend','company.vendors.index',
'company.vendors.create','company.vendors.store','company.vendors.show','company.vendors.edit','company.vendors.update',
'company.vendors.destroy','company.expenses.index','company.expenses.create','company.expenses.store','company.expenses.show',
'company.expenses.edit','company.expenses.update','company.expenses.destroy','company.contracts.activate','company.contracts.terminate',
'company.contracts.download','company.contracts.index','company.contracts.create','company.contracts.store','company.contracts.show',
'company.contracts.edit','company.contracts.update','company.contracts.destroy','company.fines.index','company.fines.create',
'company.fines.store','company.fines.show','company.fines.edit','company.fines.update','company.fines.destroy',
'company.vendor-bills.approve','company.vendor-bills.pay','company.vendor-bills.cancel','company.vendor-bills.index','company.vendor-bills.create',
'company.vendor-bills.store','company.vendor-bills.show','company.vendor-bills.edit','company.vendor-bills.update','company.vendor-bills.destroy',
'company.reports.index','company.reports.export','company.reports.export.invoices.excel','company.reports.export.invoices.pdf','company.reports.export.rentals.excel',
'company.reports.export.rentals.pdf','company.reports.export.drivers.excel','company.reports.export.drivers.pdf','company.reports.export.balance-sheet.excel','company.reports.export.balance-sheet.pdf',
'company.reports.export.profit-loss.excel','company.reports.export.profit-loss.pdf','company.reports.export.cash-flow.excel','company.reports.export.cash-flow.pdf','company.reports.export.trial-balance.excel',
'company.reports.export.trial-balance.pdf','company.reports.export.general-ledger.excel','company.reports.export.general-ledger.pdf','company.reports.export.vendor-bills.excel','company.reports.export.vendor-bills.pdf',
'company.activity.index','company.accounting.index','company.accounting.coa','company.accounting.journals','company.accounting.reports.index',
'company.accounting.reports.pnl','company.accounting.reports.balance-sheet','company.accounting.reports.trial-balance','company.accounting.reports.general-ledger','company.accounting.reports.cash-flow',
'company.accounting.payroll.index','company.accounting.payroll.create','company.accounting.payroll.store','company.accounting.payroll.show','company.accounting.payroll.post',
'company.accounting.payroll.slip','company.command-center.api','company.settings.index','company.settings.update','company.system-preferences.index',
'company.system-preferences.update','company.settings.roles.index','company.settings.roles.invite','company.settings.roles.update','driver.login',
'driver.login.submit','driver.logout','driver.dashboard','driver.trip.show','driver.trip.start',
'driver.trip.complete','driver.fuel.create','driver.fuel.store','driver.breakdown.create','driver.breakdown.store',
'driver.profile','stripe.webhook','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.activity.index','admin.agreements.create','admin.agreements.edit','admin.agreements.index','admin.analytics.index',
'admin.audit-logs.index','admin.billing.index','admin.broadcasts.index','admin.companies.index','admin.companies.show',
'admin.dashboard','admin.dashboard.index','admin.plans.create','admin.plans.edit','admin.plans.index',
'admin.requests','admin.settings.index','admin.super-admin-requests','admin.support.index','admin.support.show',
'admin.system.index','admin.telematics.dashboard','admin.trash.index','auth.login','auth.pending-approval',
'auth.register-company','auth.register-wizard','auth.super-admin.pin','auth.super-admin.register','company.command-center',
'company.dashboard.partials.event-timeline','company.dashboard.partials.quick-actions','company.dashboard.partials.risk-center','company.vendor-bills.create','company.vendor-bills.index',
'company.vendor-bills.show','company.vendors.create','company.vendors.edit','company.vendors.index','company.vendors.show',
'components.cyber-kpi','components.dashboard.fleet-map','components.dashboard.performance-intelligence','components.dashboard.quick-actions','components.dashboard.risk-efficiency',
'components.kpi-card','components.subscription-widget','customer.bookings.index','customer.dashboard','customer.invoices.download',
'customers.index','customers.show','dashboard.index','driver.auth.login','driver.breakdown.create',
'driver.dashboard','driver.fuel.create','driver.profile','driver.trip.show','drivers.index',
'drivers.show','emails.super-admin.request','exports.balance-sheet','exports.cash-flow','exports.contract-pdf',
'exports.drivers','exports.general-ledger','exports.invoices','exports.profit-loss','exports.rentals-pdf',
'exports.revenue-pdf','exports.trial-balance','exports.vendor-bills','finance.dashboard','finance.invoices',
'finance.reports','finance.transactions','fleet._index_legacy','fleet.analytics','fleet.maintenance',
'layouts.app','layouts.company','layouts.customer','layouts.driver','layouts.guest',
'layouts.partials.company-sidebar','layouts.partials.super-admin-sidebar','layouts.super-admin','portal.accounting.coa','portal.accounting.index',
'portal.accounting.journals','portal.accounting.partials.coa_row','portal.accounting.payroll.create','portal.accounting.payroll.index','portal.accounting.payroll.salary-slip',
'portal.accounting.payroll.show','portal.accounting.reports.balance-sheet','portal.accounting.reports.cash-flow','portal.accounting.reports.general-ledger','portal.accounting.reports.index',
'portal.accounting.reports.profit-loss','portal.accounting.reports.tax-reports','portal.accounting.reports.trial-balance','portal.auth.login','portal.auth.register',
'portal.bookings.create','portal.bookings.show','portal.branch_dashboard','portal.branches.index','portal.breakdowns.index',
'portal.breakdowns.show','portal.contracts.create','portal.contracts.index','portal.contracts.show','portal.customer-dashboard',
'portal.customers.create','portal.customers.edit','portal.customers.index','portal.customers.show','portal.dashboard',
'portal.drivers.create','portal.drivers.edit','portal.drivers.index','portal.drivers.show','portal.expenses.create',
'portal.expenses.index','portal.expenses.show','portal.finance.dashboard','portal.finance.invoices','portal.finance.transactions',
'portal.fines.create','portal.fines.index','portal.fines.record','portal.fleet.calendar','portal.fleet.create',
'portal.fleet.edit','portal.fleet.index','portal.fleet.maintenance','portal.fleet.show','portal.fuel.index',
'portal.fuel.show','portal.intelligence.executive','portal.invoices.download','portal.kanban.index','portal.layout',
'portal.maintenance.create','portal.maintenance.index','portal.maintenance.predictions','portal.maintenance.schedule','portal.maintenance.show',
'portal.notifications.index','portal.payments.show','portal.payments.success','portal.pricing.index','portal.rentals.contract',
'portal.rentals.create','portal.rentals.edit','portal.rentals.index','portal.rentals.show','portal.settings.index',
'portal.settings.notifications','portal.settings.roles.index','portal.settings.system','portal.trips.index','portal.trips.show',
'portal.vehicles.index','portal.vehicles.show','quote.result','rentals.create','rentals.index',
'rentals.show','reports.index','settings.index','settings.roles.index','subscription.expired',
'subscription.show','subscription.success','subscription.upgrade','welcome','laravel-exceptions-renderer::components.badge',
...
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'E:.xampp.htdocs.work shop.bus-rental-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
